...
import { View, Text, StyleSheet, ScrollView, Switch, TouchableOpacity, Platform, TextInput } from "react-native"
  ...
  ios: [
    {
      ...
      steps: ["Go to Settings > Accessibility > VoiceOver.", "Turn VoiceOver on."],
    },
    {
  ...
  android: [
    {
      ...
      steps: ["Go to Settings > Accessibility > TalkBack.", "Turn TalkBack on."],
    },
    {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text style={[styles.tabText, activeTab === "contrast" && styles.activeTabText]}>Contrast</Text>
        </AccessibleTouchable>
        ...
        >
          <Text style={[styles.tabText, activeTab === "screenReader" && styles.activeTabText]}>Documentation</Text>
        </AccessibleTouchable>
      ...
      <ScrollView style={styles.content}>
              ...
              {contrastResults.map((result, index) => (
                <View key={index} style={styles.resultCard}>
                  <View style={styles.resultHeader}>
                    ...
                    >
                      <Text style={[styles.sampleText, { color: result.foreground }]}>Text</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.resultDetails}>
                    <View style={styles.resultRow}>
                      ...
                      <View style={styles.resultValueContainer}>
                        <Text style={styles.resultValue}>{result.normalText.ratio}:1</Text>
                    ...
                    <View style={styles.resultRow}>
                      ...
                      <View style={styles.resultValueContainer}>
                        <Text style={styles.resultValue}>{result.largeText.ratio}:1</Text>
                    ...
                    {!result.normalText.passes && (
                      <Text style={styles.recommendation}>{result.normalText.recommendation}</Text>
                    )}
                  </View>
                </View>
              ))}
        ...
        {activeTab === "screenReader" && (
          <View style={styles.documentationContainer}>
            ...
            <Text style={styles.sectionTitle}>{Platform.OS === "ios" ? "VoiceOver" : "TalkBack"} Instructions</Text>
            {(Platform.OS === "ios"
                ...
                <View style={styles.checklistItemHeader}>
                  ...
                  <View style={styles.passContainer}>
                    <AccessibleTouchable
                      ...
                      style={[styles.passButton, step.pass === true && styles.selectedPassButton]}
                    >
                      <Ionicons
                      ...
                      />
                      <Text style={[styles.passButtonText, step.pass === true && styles.selectedPassButtonText]}>
                        Pass
                      </Text>
                    </AccessibleTouchable>
                    ...
                    <AccessibleTouchable
                      ...
                      accessibilityRole="button"
                      style={[styles.failButton, step.pass === false && styles.selectedFailButton]}
                    >
                      <Ionicons
                      ...
                      />
                      <Text style={[styles.failButtonText, step.pass === false && styles.selectedFailButtonText]}>
                        Fail
                      </Text>
                    </AccessibleTouchable>
                  </View>
