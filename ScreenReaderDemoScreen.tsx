...
export const ScreenReaderDemoScreen: React.FC = () => {
  ...
  return (
    <View style={[
      ...
      <View style={[
        styles.header,
        darkModeEnabled && styles.darkHeader
      ]}>
        <BackButton 
          title="Screen Reader Demo" 
          color={darkModeEnabled ? '#FFFFFF' : '#007AFF'} 
        />
      </View>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.section}>
          ...
          <Text style={[
            ...
            This screen demonstrates proper screen reader implementation. Enable VoiceOver (iOS) or TalkBack (Android) to test.
          </Text>
        </View>

        <View style={[
          styles.card,
          darkModeEnabled && styles.darkCard
        ]}>
        ...
        <View style={[
          ...
          <View style={styles.preferenceRow}>
            <View style={styles.preferenceTextContainer}>
              ...
              <Text style={[
                ...
                darkModeEnabled && styles.darkSecondaryText
              ]}>
            ...
            <Switch
              ...
              accessibilityHint={notificationsEnabled ? 
                "Double tap to disable notifications" : 
          ...
          <View style={styles.preferenceRow}>
            ...
            <Switch
              ...
              accessibilityHint={darkModeEnabled ? 
                "Double tap to disable dark mode" : 
                "Double tap to enable dark mode"
              }
              trackColor={{ false: '#D1D1D6', true: '#34C759' }}
